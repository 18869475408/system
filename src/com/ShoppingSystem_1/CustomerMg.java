...
public class CustomerMg extends Customer {//客户管理
    ...
    public void showCustomer() {
        ...
        System.out.println("客户ID\t用户名\t用户级别\t用户注册时间\t客户累计消费总金额\t用户邮箱\t用户手机号\t");
        for (int i = 0; i < customerName.size(); i++) {
            Object obj1 = customerPersonalInformation.customerID.get(i);
            Object obj2 = super.customerName.get(i);
            Object obj3 = customerPersonalInformation.customerGrade.get(i);
            Object obj4 = super.customerSignInTime.get(i);
            Object obj5 = pay.costTotal.get(i);
            Object obj6 = customerPersonalInformation.customerEmail.get(i);
            Object obj7 = customerPersonalInformation.customerPhoneNumber.get(i);
