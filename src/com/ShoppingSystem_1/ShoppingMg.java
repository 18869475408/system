...
public class ShoppingMg extends Goods {
    ...
    public void readShoppingCar(){
        try{
            BufferedReader br = new BufferedReader(new FileReader("src\\购物车商品.txt"));
            BufferedReader br1 = new BufferedReader(new FileReader("src\\购物车商品数量.txt"));
    ...
    public void writeShoppingCar(){
        try{
            BufferedWriter og = new BufferedWriter(new FileWriter("src\\购物车商品.txt"));
            BufferedWriter og1 = new BufferedWriter(new FileWriter("src\\购物车商品数量.txt"));
