...
public class GoodsManagement  extends JFrame implements ActionListener {
    ...
    String sql = "";
    ResultSet resultSet ;
    private JLabel choose1 = new JLabel("  1--罗列商品           ");
    private JLabel choose2 = new JLabel("  2--添加商品信息         ");
    private JLabel choose3 = new JLabel("  3--修改商品信息            ");
    private JLabel choose4 = new JLabel("  4--删除商品信息            ");
    ...
    public GoodsManagement (){
        ...
        choose4.setBounds(180, 45, 450, 80);
            ...
            if(cho.getText().trim().length()!=0) {
                ...
                if (choose > 0 && choose < 5) {
                    switch (choose) {
                        case 1:
                            try {
                                new Goods().showAllGoodsToAdmin();
                            } catch (SQLException ex) {
                                throw new RuntimeException(ex);
                            }
                            JOptionPane.showMessageDialog(this, "所有商品信息如下~~~");
                            this.dispose();
                            new GoodsManagement();
                            break;
                        case 2:
                        ...
                        case 3:
                            this.dispose();
                            new ModifyGoodsInterface();
                            break;
                        case 4:
                            this.dispose();
                            new DeleteGoodsInterface();
                    }
                } else {
